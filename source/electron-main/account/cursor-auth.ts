...
export type SandAuthStatus =
  ...
  | { readonly kind: "logged-in"; readonly authId?: string; readonly email?: string; readonly expiresAt?: number; readonly displayName?: string; readonly profilePictureUrl?: string; readonly isAnysphereUser?: boolean; readonly localProvider?: "codex" | "claude-code" };
