...
export function startElectronMain(deps: ElectronMainDependencies): ElectronMainRuntime {
  ...
  // Chromium's software renderer makes the large transcript surface visibly
  // stutter on Windows. Keep GPU acceleration on there by default and retain
  // an explicit compatibility escape hatch for problematic graphics drivers.
